          ...
          <div key={applicant.id} className="applicant-shared-card data-row-style">
            <div className="column-name-layout">
              {applicant.profileImg ? (
                ...
                <div className="applicant-avatar-img" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#f0f0f0' }}>
                  <FaUser style={{ color: "#808080", fontSize: "18px" }} />
                </div>
              )}
